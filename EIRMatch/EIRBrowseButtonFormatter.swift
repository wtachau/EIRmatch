...
extension EIRBrowseController {
    ...
    func setUpButton(index:Int) {
        ...
        var yOffset = CGFloat(index/3 * 110 + 80)
        
        ButtonArray[index].frame = CGRectMake((CGFloat(index%3+1)*0.25 * self.view.bounds.width) - buttonSize/2.0, yOffset, buttonSize, buttonSize)
